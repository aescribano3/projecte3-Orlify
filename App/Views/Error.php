...
<section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center">
            ...
            <p class="mb-4 text-3xl tracking-tight font-bold text-gray-900 md:text-4xl dark:text-white">Algo ha salido mal.</p>
            <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Perdon, Ha ocurrido un error, intentalo de nuevo en un rato </p>
