                    ...
                    <form class="space-y-4 md:space-y-6" action="/createorla" method="POST">
                        <div class="grid md:grid-cols-3 md:gap-4">
                            ...
                            <div>
                                ...
                                <select name="orlaplantilla" id="orlaplantilla" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                                    <option disabled selected >-- seleccionar --</option>
                            ...
                            <div>
                                <label for="orlakey" class="block mb-2 text-sm font-medium text-white">Clau Orla</label>
                                <input type="password" name="orlakey" id="orlakey" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="••••••••" required>
                            </div>
                            <div>
                                <label for="orlapublic" class="block mb-2 text-sm font-medium text-white">Clau Orla</label>
                                <select name="orlapublic" id="orlapublic" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
