                        ...
                        <div class="grid md:grid-cols-3 md:gap-4">
                            ...
                            <div>
                                ...
                                <select name="selectedorla" id="orlaplantilla" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                                    <option disabled selected>-- Seleccionar -- </option>
                                    <option value="1">Orla 1</option>
                                    <option value="2">Orla 2</option>
                                    <option value="3">Orla 3</option>
                                    <option value="4">Orla 4</option>
                                </select>
                            </div>
                        </div>
                        <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                            <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Crear orla</button>
