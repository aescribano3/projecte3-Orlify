                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="#" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            ...
                            <div>
                                <label for="rol" class="block mb-2 text-sm font-medium text-white">Rol</label>
                                <select id="rol" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                                    <option>Alumne</option>
                                    <option>Professor</option>
                                    <option>Equip Directiu</option>
