...
<div class="flex w-full">
    ...
    <aside id="sidebar-multi-level-sidebar" class= "w-2/12 shadow-md w-48 transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            <div class="h-aside px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
    ...
    <div class="w-[87.333333%] h-aside grid overflow-auto">
