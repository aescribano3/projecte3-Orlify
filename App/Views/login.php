        ...
        <div class="w-full bg-red-600 rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="#">
                    <div>
                        <label for="email" class="block mb-2 text-sm font-medium text-white">Nom Usuari / Email</label>
                    ...
                    <button type="submit" class="w-full text-white text-primary-700 bg-white font-medium rounded-lg text-sm px-5 py-2.5 text-center">Inicia sessió</button>
                    <p class="text-sm font-light text-white">
                      Encara no tens un compte? <a href="#" class="font-medium text-white hover:underline">Registra't</a>
                    </p>
                </form>
            </div>
        </div>
